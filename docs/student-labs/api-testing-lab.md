# Student Lab #2: API Testing (Postman)

## Introduction to Postman
Postman is a powerful and user-friendly tool designed for API testing, development, and collaboration. It allows developers and testers to send requests to APIs, inspect responses, and validate functionality. In this lab, we will explore the basics of Postman and how to use it effectively for API testing.

## Lab: Testing Library Management System API with Postman
### Objective
...
5\. Install postman from [postman.com/downloads](https://www.postman.com/downloads/)

6\. Start the project server
```
